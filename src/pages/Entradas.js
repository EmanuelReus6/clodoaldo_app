...
export default function Entradas({navigation}) {
  ...
  useEffect (() => {
    const tasksCollection = collection(database, 'Entrada')
  ...
  function deleteTask (id) {
    const taskdocRef = doc(database, 'Entrada', id)
    ...
    return (
        <View style={styles.container}>
          <View style={styles.topBar}>
            ...
            />
              <Text style={styles.txtEntradas}> Entradas </Text>
            ...
            return(
              <View>
                ...
                <Text style={styles.txtitem}> 
                  Cod: {item.codigo}  CodProd: {item.codproduto} CodFor: {item.codfornecedor}</Text>
...
{/*                 <Text
        ...
        />
          ...
          <TouchableOpacity style={styles.btnNewTask} onPress={() => navigation.navigate('AddEntrada')}>
